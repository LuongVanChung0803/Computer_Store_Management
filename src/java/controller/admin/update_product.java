...
public class update_product extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int id_nhacungcap = Integer.parseInt(request.getParameter("productBrand"));
        ...
        ps.updateProduct(ten_sanpham, id_nhacungcap, gia,gia_ban, mo_ta, so_luong, link_anh, id_sanpham);
