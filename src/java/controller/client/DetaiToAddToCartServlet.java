 ...
 * @author hc
 */
@WebServlet(name = "DetaiToAddToCartServlet", urlPatterns = {"/DetaiToAddToCartServlet"})
public class DetaiToAddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetaiToAddToCartServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetaiToAddToCartServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        float gia_ban = Float.parseFloat(request.getParameter("gia_ban"));
        ...
        if (idNguoiDungParam == null || idNguoiDungParam.isEmpty()) {
            ...
            if (existingItem != null) {
                ...
                response.sendRedirect("productDetailServlet?id=" + id_sanpham);
