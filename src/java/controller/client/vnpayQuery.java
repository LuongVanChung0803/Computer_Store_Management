...
public class vnpayQuery extends HttpServlet {
    ...
    throws ServletException, IOException {
        // Gọi vnpay_ipn.jsp
//    request.getRequestDispatcher("./views/vnpay_ipn.jsp").forward(request, response);

    // Sau đó gọi vnpay_return.jsp
    request.getRequestDispatcher("./views/vnpay_return.jsp").forward(request, response);
    } 
