...
public class CartItem {
    ...
    public CartItem(int id_cart, int id_sanpham, float gia_ban, int so_luong, int id_nguoidung, String link_anh) {
    ...
    public String toString() {
        return "CartItem{" + "id_cart=" + id_cart + ", id_sanpham=" + id_sanpham + ", gia_ban=" + gia_ban + ", so_luong=" + so_luong + ", id_nguoidung=" + id_nguoidung + ", link_anh=" + link_anh + '}';
    }
