...
public class ChiTietVanChuyen {
    ...
    public ChiTietVanChuyen(int id_vanchuyen, int id_donhang, Date ngay_vanchuyen, String dia_chi, String thanh_pho, String tinh_trang, String quoc_gia, String ma_theo_doi) {
        this.id_vanchuyen = id_vanchuyen;
